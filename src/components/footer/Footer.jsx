...
const Footer = () => {
  return (
    <footer className="border-t p-8 md:px-13  px-2">
      <div className="md:flex gap-16">
        <div className="mb-8 md:mb-0  flex items-center justify-center md:flex-none">
          <img src="/numah-logo.png" alt="numah-logo" />
        </div>
        <div className="md:flex  w-full justify-between">
          <div className="flex justify-between md:gap-20 gap-4 whitespace-nowrap lg:gap-40 ">
